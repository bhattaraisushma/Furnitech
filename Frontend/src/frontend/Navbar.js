...
if(islogged)
  ...
  return (
    <div className="flex flex-row z-[1000]  justify-between items-center  bg-white px-[3rem] text-black h-[5rem] w-[100%]  shadow-xl gap-[6rem]   text-xl font-semibold fixed ">
